            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <section class="content-header">
                    <div class="container-fluid">
                      <div class="row mb-2">
                        <div class="col-sm-6">
                          <h1>Tableau de bord gestion facture</h1>
                        </div>
                        <div class="col-sm-6">
                                    ...
                                    <div class="card-body">
                                        <table id="facture" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($toutesLesFactures as $facture)
                                                    <tr>
                                                        <td>{{$facture->nomPrenom}} </td>
                                                        <td>{{$facture->numeroDossier}} </td>
                                                        <td>{{$facture->montantTotal}} </td>
                                                        <td><a class="btn btn-outline-success" href="{{route('facture.modifier', ['id' => $facture->id]) }}" role="button">Modifier</a></td>
                                                        <td><a class="btn btn-outline-success" href="{{route('facture.imprimer', ['id' => $facture->id]) }}" role="button">Imprimer</a></td>
                                                    </tr>
                                                @endforeach
